...
@interface FLFolderListViewController ()<CameraObject, MFMailComposeViewControllerDelegate>
@property (nonatomic, strong) FLAccountSetting *accountSetting;
@property (nonatomic, strong) NSArray *folderModels;
...
- (void)fetchResults {
    ...
    self.service.didFinishFetchResults = ^{
        ...
        strong.folderModels = strong.service.listModelFolder;
