...
- (void)viewDidLoad {
    ...
    UIImage *image = [[UIImage imageNamed:@"bg_navigation"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 0) resizingMode:UIImageResizingModeStretch];
...
- (void)_setupLabels {
    ...
    if (!_failedAttemptLabel) {
        ...
        _failedAttemptLabel.text = [NSString stringWithFormat:@"%d %@", 1, _LSFromTable(@"failedAttemp.strings", @"LTHPasscodeViewController", @"Passcode Failed Attempt.")];
...
- (void)_prepareNavigationControllerWithController:(UIViewController *)viewController {
    ...
    UIButton *buttonCancel = fl_buttonCancel();
    UIBarButtonItem *buttomBar = [[UIBarButtonItem alloc] initWithCustomView:buttonCancel];
    self.navigationItem.rightBarButtonItem =  buttomBar;
    [buttonCancel addTarget:self action:@selector(_cancelAndDismissMe) forControlEvents:UIControlEventTouchUpInside];
...
//													  userInfo: nil];
	...
	if (_failedAttempts == 1) {
		...
		_failedAttemptLabel.text = [NSString stringWithFormat:@"%ld %@", (long)_failedAttempts, _LSFromTable(@"failedAttemp.strings", @"LTHPasscodeViewController", @"Passcode Failed Attempt.")];
	}
...
- (void)_resetUIForReEnteringNewPasscode {
	...
	_failedAttemptLabel.hidden = NO;
	_failedAttemptLabel.text = _LSFromTable(@"passcodes.did.not.match.try.again", @"LTHPasscodeViewController", @"Passcodes did not match. Try again.");
...
- (void)_loadStringDefaults {
    self.enterOldPasscodeString = _LSFromTable(@"enter.your.old.passcode", @"LTHPasscodeViewController", @"Enter your old passcode");
    self.enterPasscodeString = _LSFromTable(@"enter.your.pass.code", @"LTHPasscodeViewController", @"Enter your passcode");
    self.enablePasscodeString = _LSFromTable(@"enable.pass.code", @"LTHPasscodeViewController", @"Enable Passcode");
    self.changePasscodeString = _LSFromTable(@"change.pass.code", @"LTHPasscodeViewController", @"Change Passcode");
    self.turnOffPasscodeString = _LSFromTable(@"turn.off.passcode", @"LTHPasscodeViewController", @"Turn Off Passcode");
    self.reenterPasscodeString = _LSFromTable(@"reenter.your.passcode", @"LTHPasscodeViewController", @"Re-enter your passcode");
    self.reenterNewPasscodeString = _LSFromTable(@"reenter.your.new.passcode", @"LTHPasscodeViewController", @"Re-enter your new passcode");
    self.enterNewPasscodeString = _LSFromTable(@"enter.your.new.password", @"LTHPasscodeViewController", @"Enter your new passcode");
